...
public class stockCSV {
	...
	public static void main(String[] args) {
			...
			String symbol = "AAPL";
			ArrayList<String> arr = new ArrayList<String>(TagsTable.tags.values());
			System.out.println("Printing done");
			String tagList = "";
			...
			ArrayList<String> arr2 = new ArrayList<String>(TagsTable.tags.keySet());
			String keyList = "";
			for(int i = 0; i < arr.size(); i++){
			...
			for(int i = 0; i< TagsTable.tags.size() ; i++ ){
